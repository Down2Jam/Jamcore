...
export const trackInputSchema = z.object({
  ...
  integratedLufs: z.number().finite().min(-100).max(10).nullable().optional(),
...
export const createGameSchema = z.object({
  ...
  playableBuildUrl: z.string().regex(/^\/game-builds\/[0-9a-f-]{36}\/index\.html$/i).nullable().optional(),
  playableBuildAspectRatio: z.enum(ITCH_EMBED_ASPECT_RATIOS).nullable().optional(),
  playableBuildShowFullscreenButton: z.boolean().optional().default(true),
...
export const updateGameSchema = z.object({
  ...
  playableBuildUrl: z.string().regex(/^\/game-builds\/[0-9a-f-]{36}\/index\.html$/i).nullable().optional(),
  playableBuildAspectRatio: z.enum(ITCH_EMBED_ASPECT_RATIOS).nullable().optional(),
  playableBuildShowFullscreenButton: z.boolean().optional(),
