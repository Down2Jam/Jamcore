...
type ReactionSummaryRef = {
  id?: number;
  slug: string;
};

type CommentReactionEntry = {
  reaction: ReactionSummaryRef;
  userId: number;
  reactionId: number;
  createdAt?: Date;
...
type ViewerComment = {
  deletedAt?: Date | null;
  removedAt?: Date | null;
  likes?: CommentLikeRef[];
  commentReactions?: CommentReactionEntry[];
  children?: ViewerComment[];
...
export function mapCommentsForViewer(
  comments: ViewerComment[] | undefined,
