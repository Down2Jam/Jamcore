...
export function createJamcoreClient(config: JamcoreClientConfig = {}) {
  ...
  return {
    listCurrentJamGamesForInspection: () => request("GET", "/admin/jam-games", {  }),
    ...
    listLinkablePostGames: () => request("GET", "/posts/linkable-games", {  }),
    ...
    getCommentReplies: (query: RequestOptions["query"] = undefined) => request("GET", "/comment/replies", { query }),
    ...
    listLanguageUsage: () => request("GET", "/languages", {  }),
    updateCurrentLanguage: (body: unknown) => request("PUT", "/languages/current", { body }),
    ...
    pollDeviceAuth: (body: unknown) => request("POST", "/device/token", { body }),
    ...
    getTwitchConnectionAvailability: () => request("GET", "/connections/twitch", {  }),
    manageTwitchConnection: (body: unknown) => request("POST", "/connections/twitch", { body }),
    refreshSession: () => request("POST", "/session/refresh", {  }),
    authorizeApp: (query: RequestOptions["query"] = undefined) => request("GET", "/oauth/authorize", { query }),
    previewAppAuthorization: (query: RequestOptions["query"] = undefined) => request("GET", "/oauth/request", { query }),
    approveAppAuthorization: (body: unknown) => request("POST", "/oauth/authorize", { body }),
    exchangeOAuthToken: (body: unknown) => request("POST", "/oauth/token", { body }),
    revokeOAuthToken: (body: unknown) => request("POST", "/oauth/revoke", { body }),
    listOAuthApps: () => request("GET", "/oauth/apps", {  }),
    registerOAuthApp: (body: unknown) => request("POST", "/oauth/apps", { body }),
    disableOAuthApp: (body: unknown) => request("DELETE", "/oauth/apps", { body }),
    listAppConnections: () => request("GET", "/oauth/connections", {  }),
    revokeAppConnection: (body: unknown) => request("DELETE", "/oauth/connections", { body }),
    getMessageCounts: () => request("GET", "/messages/counts", {  }),
    listConversations: () => request("GET", "/messages/conversations", {  }),
    createConversation: (body: unknown) => request("POST", "/messages/conversations", { body }),
    getConversationMessages: (id: string) => request("GET", `/messages/conversations/${id}/messages`, {  }),
    sendConversationMessage: (id: string, body: unknown) => request("POST", `/messages/conversations/${id}/messages`, { body }),
    updateConversation: (id: string, body: unknown) => request("PUT", `/messages/conversations/${id}`, { body }),
    blockUser: (userSlug: string) => request("PUT", `/users/${userSlug}/block`, {  }),
    unblockUser: (userSlug: string) => request("DELETE", `/users/${userSlug}/block`, {  }),
    getGameLeaderboards: (gameSlug: string, query: RequestOptions["query"] = undefined) => request("GET", `/games/${gameSlug}/leaderboards`, { query }),
    getGameAchievements: (gameSlug: string, query: RequestOptions["query"] = undefined) => request("GET", `/games/${gameSlug}/achievements`, { query }),
    getLeaderboardScores: (leaderboardId: string, query: RequestOptions["query"] = undefined) => request("GET", `/leaderboards/${leaderboardId}/scores`, { query }),
    getPlayerGameContext: (query: RequestOptions["query"] = undefined) => request("GET", "/self/game-context", { query }),
    getPlayerAchievements: (query: RequestOptions["query"] = undefined) => request("GET", "/self/achievements", { query }),
    getPlayerScores: (query: RequestOptions["query"] = undefined) => request("GET", "/self/scores", { query }),
  };
}
